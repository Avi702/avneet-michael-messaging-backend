...
describe("MessagingRepository", () => {
    ...
    describe("findChatById method", () => {
        ...
        test("does not find a chat that doesn't exist", async () => {
    ...
    describe("findImageById method", () => {
        ...
        test("returns null when image does not exist", async () => {
            const found = await repository.findImageById(OID_1.toString());
    ...
    describe("findMessageById method", () => {
        ...
        test("returns null when message does not exist", async () => {
            const found = await repository.findMessageById(OID_1.toString());
            expect(found).toBe(null);
        });
    });
});
